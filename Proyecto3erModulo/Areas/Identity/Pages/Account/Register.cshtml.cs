...
namespace Proyecto3erModulo.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(10, ErrorMessage = "El {0} tiene que tener al menos {2} de longitud y {1} como máximo.", MinimumLength = 6)]
                ...
                if (result.Succeeded)
                {
                    if (Input.IsVendedor)
                    {
                        Vendedor vendedor = new Vendedor
                        {
                            ...
                            TipoDeEmpresa = Input.TipoDeEmpresa,
