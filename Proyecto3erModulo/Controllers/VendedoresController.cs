...
namespace Proyecto3erModulo.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreDeEmpresa,TipoDeEmpresa,NumeroRegistro")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreDeEmpresa,TipoDeEmpresa,NumeroRegistro")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
